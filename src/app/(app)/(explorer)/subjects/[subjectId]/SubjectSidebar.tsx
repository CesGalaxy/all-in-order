...
import SubjectSidebarDropdown from "@/app/(app)/(explorer)/subjects/[subjectId]/SubjectSidebarDropdown";
import { getTranslations } from "next-intl/server";
import ModalButton from "@/components/utils/ModalButton";
import CreateTopicModal from "@/collections/topic/components/modals/CreateTopicModal";
import { notFound } from "next/navigation";

export default async function SubjectSidebar({ params }: { params: Promise<{ subjectId: string }> }) {
