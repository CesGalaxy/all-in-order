...
export default function NavRecentNotebooks({ workspaceId, notebooksQuery }: {
    // notebookId?: string,
    workspaceId: string,
    ...
    if (error) return <ErrorCard title="Error getting notebooks!" message={error.message}
                    ...
                    <SidebarMenuItem key={item.id}>
                        ...
                        <DropdownMenu>
                            ...
                            >
                                ...
                                <DropdownMenuSeparator/>
                                <DropdownMenuItem
                                    onClick={() => navigator.clipboard.writeText(window.location.origin + "/notebooks/" + item.id).then(() => toast("Link copied to clipboard!"))}>
