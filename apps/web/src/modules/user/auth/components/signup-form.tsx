...
import { signup } from "@/modules/user/auth/actions";
import { zodResolver } from "@hookform/resolvers/zod";
import { SIGNUP_SCHEMA } from "@/modules/user/auth/schemas";
...
export function SignupForm({
    ...
    const { form, action, handleSubmitWithAction } = useHookFormAction(
        ...
        zodResolver(SIGNUP_SCHEMA),
        {
            ...
            formProps: { mode: "all", defaultValues: { name: "", username: "", email: "", password: "" } },
            errorMapProps: {},
        }
    );
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input type="text" placeholder="Myself" autoComplete="name" {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input type="text" placeholder="mycoolusername" autoComplete="username" {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
